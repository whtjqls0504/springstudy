...
public class BoardConfig {
  ...
  @Bean
  public BoardDto boardDto2() {   // <bean class="BoardDto" id="boardDto1" />
    return new BoardDto(2, "제목2", "작성자2");
  }
  
  @Bean
  public BoardDto boardDto3() {   // <bean class="BoardDto" id="boardDto1" />
    return new BoardDto(3, "제목3", "작성자3");
  }
  
  // BoardDao bean 생성 BoardServiceImpl와 연결되어있다.
  @Bean
  ...
  // iBoardService bean 생성 BoardController와 연결되어있다.
  @Bean
